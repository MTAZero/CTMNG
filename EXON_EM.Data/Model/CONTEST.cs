namespace EXON_EM.Data.Model
{
    ...
    public partial class CONTEST
    {
        ...
        public CONTEST()
        {
            ...
            BeginDate = Helper.ConvertDateTimeToUnix(DateTime.Now);
            EndDate = Helper.ConvertDateTimeToUnix(DateTime.Now);
            BeginRegistration = Helper.ConvertDateTimeToUnix(DateTime.Now);
            EndRegistration = Helper.ConvertDateTimeToUnix(DateTime.Now);
            CreatedQuestionStartDate = Helper.ConvertDateTimeToUnix(DateTime.Now);
            CreatedQuestionEndDate = Helper.ConvertDateTimeToUnix(DateTime.Now);
            CreatedDate = Helper.ConvertDateTimeToUnix(DateTime.Now);
        }
