...
namespace EXON.RegisterManager.Module.Report {
    ...
    public partial class Receipt : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row AddDataTable1Row(string FullName, int Sex, string IdentityCardNumber, int ReceivedDate, string Expr1, System.DateTime Birthday, double Cost) {
            ...
            private void InitClass() {
                ...
                this.columnReceivedDate = new global::System.Data.DataColumn("ReceivedDate", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class DataTable2DataTable : global::System.Data.TypedTableBase<DataTable2Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable2Row AddDataTable2Row(string SubjectName, int Fee, double Cost) {
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public int Sex {
                get {
                    try {
                        return ((int)(this[this.tableDataTable1.SexColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public string IdentityCardNumber {
                get {
                    try {
                        return ((string)(this[this.tableDataTable1.IdentityCardNumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'IdentityCardNumber\' in table \'DataTable1\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableDataTable1.IdentityCardNumberColumn] = value;
                }
            }
            ...
            public int ReceivedDate {
                get {
                    return ((int)(this[this.tableDataTable1.ReceivedDateColumn]));
                }
                set {
            ...
            public bool IsIdentityCardNumberNull() {
                return this.IsNull(this.tableDataTable1.IdentityCardNumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetIdentityCardNumberNull() {
                this[this.tableDataTable1.IdentityCardNumberColumn] = global::System.Convert.DBNull;
            }
        ...
        public partial class DataTable2Row : global::System.Data.DataRow {
            ...
            public int Fee {
                get {
                    return ((int)(this[this.tableDataTable2.FeeColumn]));
                }
                set {
                    this[this.tableDataTable2.FeeColumn] = value;
                }
            }
            ...
            public double Cost {
                get {
                    try {
                        return ((double)(this[this.tableDataTable2.CostColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsCostNull() {
                return this.IsNull(this.tableDataTable2.CostColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetCostNull() {
                this[this.tableDataTable2.CostColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace EXON.RegisterManager.Module.Report.ReceiptTableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EXON.RegisterManager.Properties.Settings.Default.EXON_SYSTEMConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT         REGISTERS.FullName,DATEADD( ss,REGISTERS.DOB,'1970-01-01') as Birthday, REGISTERS.Sex, REGISTERS.IdentityCardNumber,  
                         RECEIPTS.ReceivedDate, STAFFS.FullName AS Expr1,RECEIPTS.Cost
FROM            RECEIPTS INNER JOIN
                         REGISTERS ON RECEIPTS.RegisterID = REGISTERS.RegisterID INNER JOIN
                         REGISTERS_SUBJECTS ON REGISTERS.RegisterID = REGISTERS_SUBJECTS.RegisterID INNER JOIN
                         STAFFS ON RECEIPTS.StaffID = STAFFS.StaffID INNER JOIN
                         SUBJECTS ON REGISTERS_SUBJECTS.SubjectID = SUBJECTS.SubjectID
WHERE        (REGISTERS.RegisterID = @reID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@reID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "RegisterID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(Receipt.DataTable1DataTable dataTable, int reID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(reID));
        ...
        public virtual Receipt.DataTable1DataTable GetData(int reID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(reID));
            Receipt.DataTable1DataTable dataTable = new Receipt.DataTable1DataTable();
    ...
    public partial class DataTable2TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        SUBJECTS.SubjectName, SCHEDULES.Fee, CONTEST_FEES.Cost
FROM            REGISTERS_SUBJECTS INNER JOIN
                         SUBJECTS ON REGISTERS_SUBJECTS.SubjectID = SUBJECTS.SubjectID INNER JOIN
                         SCHEDULES ON SUBJECTS.SubjectID = SCHEDULES.SubjectID INNER JOIN
                         REGISTERS ON REGISTERS_SUBJECTS.RegisterID = REGISTERS.RegisterID AND SCHEDULES.ContestID = REGISTERS.ContestID INNER JOIN
                         CONTESTS ON SCHEDULES.ContestID = CONTESTS.ContestID AND REGISTERS.ContestID = CONTESTS.ContestID INNER JOIN
                         CONTEST_FEES ON CONTESTS.ContestID = CONTEST_FEES.ContestID
WHERE        (REGISTERS.RegisterID = @ReID) AND (SCHEDULES.Status > 0)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ReID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "RegisterID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(Receipt.DataTable2DataTable dataTable, int ReID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ReID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual Receipt.DataTable2DataTable GetData(int ReID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ReID));
            Receipt.DataTable2DataTable dataTable = new Receipt.DataTable2DataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
    }
