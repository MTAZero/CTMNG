...
namespace AnalogClock
{
    ...
    public partial class AnalogClock : UserControl
    {
        ...
        private string _caption = "MTA CLOCK";
        ...
        private void DrawDate(Graphics g)
        {
            ...
            g.DrawString(_calendar.GetDayOfMonth(CL.Persistance.Common.GetDateTimeServer()).ToString() , new Font("Lucida Console", _radius * .08f, FontStyle.Bold), Brushes.Black,
            ...
            if (_datestyle == DateStyles.Full)
            {
                ...
                g.DrawString(CL.Persistance.Common.GetDateTimeServer().DayOfWeek.ToString().Substring(0, 3).ToUpper(), new Font("Lucida Console", _radius * .09f, FontStyle.Bold), Brushes.Black,
        ...
        {
            int hour = CL.Persistance.Common.GetDateTimeServer().Hour % 12;
            int minute = CL.Persistance.Common.GetDateTimeServer().Minute;
            int second = CL.Persistance.Common.GetDateTimeServer().Second;
